...
namespace mmx
{
    namespace ipc
    {
        ...
        public:
            ...
            int SendMedia(const headers::PMSG_HEADER pmsg, const char* data = nullptr, int flags = 0);
            int RecvMedia(headers::PMSG_HEADER pmsg, char* data = nullptr, unsigned short size = 0, int flags = 0);
        };
    }
}
